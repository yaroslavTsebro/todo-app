...
export class UserCreateDto {
  ...
  @IsString({message: ErrorMessages.PASSWORD_MUST_BE_STRING})
  @MinLength(2, {message: ErrorMessages.PASSWORD_IS_TOO_SHORT + 2})
  @MaxLength(50, {message: ErrorMessages.PASSWORD_IS_TOO_LONG + 50})
  password: string;
